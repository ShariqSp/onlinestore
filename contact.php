		...
		<div id="main" class="shell">
			...
			<div id="content">
              <div class="support_desc">
  				...
  				<p> Admin On behalf on <b>shariq</b> company we have welcome you 24/7 live support 
...
$(document).ready(function(){ 
    $("#submit").click(function() { 
				...
				<div class="col span_1_of_3">
      			...
      			<div class="company_address">
				     	<h2>Company Information :</h2>
						    	<p><big> shariq Store</big> Is A Online Sales System Company Established In india</p>
		...
		<!-- End Main -->
							 ...
							 <div class="shout_box">
     <div class="header"> live Discussion of shariq store <div class="close_btn">&nbsp;</div></div>
